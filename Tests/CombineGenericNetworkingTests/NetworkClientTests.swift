...
import Combine
import Foundation
@testable import CombineGenericNetworking
...
struct MockNetworkRequest: NetworkRequest {
    ...
    var url: URL? = URL(string: "https://somedummyurl")!
...
class NetworkClientImpTests: XCTestCase {
    ...
    var request: MockNetworkRequest!
    ...
    func testPerformRequest_Success() {
        ...
        let request = MockNetworkRequest() // Use a valid request object
